...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 16, 2024 at 03:28 AM
...
-- Database: `authentest`
--
CREATE DATABASE IF NOT EXISTS `authentest` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `authentest`;
--
-- Database: `banhoa`
--
CREATE DATABASE IF NOT EXISTS `banhoa` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `banhoa`;
...
CREATE TABLE IF NOT EXISTS `bosuutap` (
  ...
  `ten_bo_suu_tap` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(6, 6, '2024-12-14 09:41:40'),
(5, 5, '2024-12-14 09:39:08'),
(7, 7, '2024-12-14 14:16:35'),
(8, 8, '2024-12-14 15:27:19'),
(9, 9, '2024-12-14 15:28:08'),
(10, 10, '2024-12-15 10:29:07'),
(11, 10, '2024-12-15 10:29:07');
...
CREATE TABLE IF NOT EXISTS `doituong` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten_doi_tuong` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `hoadon` (`id`, `user_id`, `ten_nguoi_mua`, `dia_chi`, `so_dien_thoai`, `ngay_dat_hang`, `tong_tien`) VALUES
(32, 9, '23432', '24234', '234234', '2024-12-15 18:47:18', 0.00),
(31, 9, '23432', '24234', '234234', '2024-12-15 18:46:47', 0.00),
(30, 9, '23432', '24234', '234234', '2024-12-15 18:44:09', 220000.00),
(29, 9, '23432', '24234', '234234', '2024-12-15 18:43:15', 297000.00),
(28, 9, 'minhquan', '123', '456', '2024-12-15 18:40:45', 594000.00);
...
CREATE TABLE IF NOT EXISTS `kieudang` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten_kieu_dang` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `mausac` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ten_mau_sac` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(23, '123123', 1231231.00, '231231231', NULL, NULL, 3, 1, 1, 1, 1),
(3, 'Hoa Tình Yêu Hồng', 350000.00, 'Bó hoa tình yêu với những bông hoa hồng hồng lãng mạn.', 'https://hoayeuthuong.com/hinh-hoa-tuoi/bo-hoa-tuoi/15549_blink.jpg', 4.80, 3, 3, 3, 3, 2),
(4, 'Hoa Cảm Ơn Trắng', 200000.00, 'Hoa cảm ơn với hoa cúc trắng thanh khiết.', 'https://hoayeuthuong.com/hinh-hoa-tuoi/binh-hoa-tuoi/15325_nong-nhiet.jpg', 4.60, 1, 3, 1, 4, 1),
(5, 'Hoa Sinh Nhật Màu Hồng', 270000.00, 'Bó hoa sinh nhật tươi mới với hoa hồng hồng và cẩm chướng.', 'https://hoayeuthuong.com/hinh-hoa-tuoi/hoa-khuyen-mai/13382_ngay-em-dem.jpg', 4.30, 1, 1, 2, 1, 2),
(6, 'Hoa Mừng Tốt Nghiệp Đỏ', 400000.00, 'Bó hoa mừng tốt nghiệp với hoa hồng đỏ và lan.', 'https://hoayeuthuong.com/hinh-hoa-tuoi/hoa-khuyen-mai/13382_ngay-em-dem.jpg', 4.90, 2, 2, 3, 2, 3),
(7, 'Hoa Chúc Mừng Tươi', 320000.00, 'Bó hoa chúc mừng với các loài hoa tươi sáng và vui tươi.', 'https://hoayeuthuong.com/hinh-hoa-tuoi/thumb/bo-hoa-tuoi/11597_only-rose-18-size-50-bong.jpg', 4.40, 2, 1, 1, 3, 1),
...
(9, 'Hoa Tặng Bạn Bè Màu Cam', 280000.00, 'Hoa tặng bạn bè với hoa hồng cam và hoa lan.', 'https://hoayeuthuong.com/hinh-hoa-tuoi/thumb/bo-hoa-tuoi/13251_cau-hon.jpg', 4.20, 1, 4, 1, 2, 2),
...
(24, 'Test', 555.00, 'đây là hoa mới thêm', 'https://hoayeuthuong.com/hinh-hoa-tuoi/binh-hoa-tuoi/15325_nong-nhiet.jpg', NULL, 1, 6, 2, 3, 5),
(22, '123123', 1231231.00, '231231231', 'uploads/Screenshot 2024-10-09 205245.png', NULL, 3, 1, 1, 1, 1);
...
(7, '1234', '$2y$10$pMe4C9ku5gLGMpnyJaQwnutLv0HEsIfc/10v4x3nWTSt5W.35psyi', NULL, '2024-12-14 14:16:35', ''),
(6, '1', '$2y$10$.P7EkRDMrnmTnJzt3zmRK.AHB5X4G3KeCeJJs4MOMc00HSY5nHvQm', NULL, '2024-12-14 09:41:40', ''),
(5, '123', '$2y$10$ageBJ99Mp2pt/NFrQOqBtuSnTBb1JW9Z3UhzzGPVAW/TSxahc.sya', NULL, '2024-12-14 09:39:08', ''),
(8, 'minhquan', '$2y$10$f17mB4don3eOs2P/XIWLAey0q3uAaGz9vZ8H2pq.n.MuJs5fvyVf6', NULL, '2024-12-14 15:27:19', 'user'),
(9, 'admin1', '$2y$10$P9bGgbIpMFTZO/tU5CkrVuTu2yUrovlLmioGul0wPdlbJASK7P51C', NULL, '2024-12-14 15:28:08', 'admin'),
(10, 'minhquan123', '$2y$10$UsvWBaCAyM4CQsNmXP2CC.f1eQ4iSMKrlkCcpHYtAKZbcnfU8hEkW', NULL, '2024-12-15 10:29:07', 'user');

--
-- Triggers `users`
--
DROP TRIGGER IF EXISTS `create_cart_after_user_insert`;
DELIMITER $$
CREATE TRIGGER `create_cart_after_user_insert` AFTER INSERT ON `users` FOR EACH ROW BEGIN
...
-- Database: `hocphp`
--
CREATE DATABASE IF NOT EXISTS `hocphp` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `hocphp`;
--
-- Database: `store`
--
...
(1, 'Default', '', 1, '2024-11-03 17:14:10', '2024-11-03 17:14:10');
...
('983c2371c04a00a9a6e8c74f45', '{\"currency\":\"USD\",\"review_token\":\"e444514c54ac876b6fd6581acbd8fcd6\"}', '2024-11-04 17:14:38');
...
(99, 0, 'config', 'config_email', 'Contsummer@gmail.com', 0),
...
(215, 0, 'config', 'config_encryption', '', 0),
...
(1, 1, 'admin', '$2y$10$cZFJqz8fw.EVs8TMcUdpvuFGTh7Uzx7vlbB6e4i/BzAtIG3Kw87mK', 'John', 'Doe', 'Contsummer@gmail.com', '', '', '', 1, '2024-11-03 17:14:10');
...
-- Database: `yame`
--
CREATE DATABASE IF NOT EXISTS `yame` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `yame`;
...
(2, 'Áo khoác', 'Áo khoác dù chống nắng, cản gió, trượt nước - Phong cách năng động, đậm chất mùa hè.\r\n1. Kiểu sản phẩm: Áo khoác không nón dáng vừa.\r\n2. Ưu điểm:\r\nCản gió: Giữ ấm và bảo vệ khỏi gió lạnh.\r\nTrượt nước: tránh được những cơn mưa nhỏ bất chợt, và cũng có thể khoác tránh sương khi đêm về.\r\nNhẹ, nhanh khô.\r\n3. Chất liệu: Vải Parachute (100% Polyester)\r\n4. Kỹ thuật:\r\nThêu 2D.\r\nRã phối 2 màu Trắng - Xanh biển tạo điểm nhấn.\r\nDây kéo chắc chắn, đầu khóa kim loại được bọc nhựa an toàn.\r\n5. Phù hợp với ai: Thiết kế đơn giản, năng động, phù hợp với phong cách thời trang nam tính.\r\n6. Thuộc Bộ Sưu Tập: The Seafarer - lấy cảm hứng từ biển cả, mang đến những thiết kế trẻ trung, năng động và đậm chất mùa hè.\r\n7. Các tên thường gọi hoặc tìm kiếm: Áo khoác dù, áo khoác nam, Áo khoác màu xanh dương, Áo khoác Gam Màu Đại Dương.', 497000.00, 111, 'image_product/9e81cf89-94c5-6000-a937-001b3ee41b3d.jpg', 1),
(3, 'quần ', 'quần ', 1232131.00, 12312, 'image_product/th.jfif', 2),
(4, 'aoooo', 'Áo khoác thun French Terry giữ ấm, chống nắng, phù hợp cho mùa đông.\r\n1. Kiểu sản phẩm: Áo khoác thun\r\n2. Ưu điểm:\r\n● Mặc ấm: Chất liệu thun French Terry giúp giữ ấm cho cơ thể trong thời tiết lạnh.\r\n● Chống nắng: Áo khoác có thể là một lớp bảo vệ khỏi tác động của tia UV khi bạn ra ngoài.\r\n3. Chất liệu: Vải CVC French Terry (72% Cotton, 28% Polyester) là một loại vải mềm mại, thoáng khí và dễ mặc.\r\n4. Kỹ thuật: Áo được in dẻo, tạo ra hình ảnh hoặc chữ viết trên bề mặt vải.\r\n5. Phù hợp với ai : Áo khoác này được thiết kế để giữ ấm và chống nắng, phù hợp cho mùa đông hoặc những ngày lạnh.\r\n6. Thuộc Bộ Sưu Tập nào: Bộ sưu tập No Style mang ý nghĩa thời trang đa dạng, độc đáo và theo xu hướng. Đây là tập hợp các sản phẩm thiết kế với sự tinh tế, phù hợp cho những người yêu thích sự tự do trong cách ăn mặc.\r\n7. Các tên thường gọi hoặc tìm kiếm về sản phẩm này: Áo khoác thun, Áo khoác giữ ấm, Áo khoác nam.', 12312.00, 12321, 'image_product/aaff2740-8c70-a500-1e65-001b73af92a5.jpg', 1),
(5, 'ao', 'Áo khoác jean chống nắng Seventy Seven - Phong cách đơn giản, năng động\r\n1.Kiểu sản phẩm: Áo khoác jean không nón dáng vừa.\r\n2. Ưu điểm: Dễ dàng phối đồ với nhiều phong cách khác nhau, từ cá tính đến thanh lịch, không chỉ mang đến vẻ thời trang mà còn có công dụng chống nắng hiệu quả.\r\n3. Chất liệu: 100% cotton vải jean bền bỉ, ít bị nhàu, giữ màu tốt, thấm hút tốt.\r\n4. Kỹ thuật: Thiết kế đơn giản, tiện dụng, may đắp simili tạo điểm nhấn độc đáo, tăng tính thẩm mỹ cho sản phẩm.\r\n5. Phù hợp với ai: Người yêu thích phong cách đơn giản, năng động từ đi làm đến đi chơi.\r\n6. Thuộc Bộ Sưu Tập: Seventy Seven, nơi mọi outfit đều trở nên đơn giản, dễ dàng.\r\n7. Các tên thường gọi hoặc tìm kiếm: Áo khoác jean nam, áo khoác denim, áo khoác không nón, áo khoác màu xanh đậm.', 12313.00, 123, 'image_product/6cb6d792-0787-4301-f118-001b4eda10f6.jpg', 1),
(6, '123', 'Áo khoác nhung nam cá tính, chống nắng hiệu quả\r\n1. Kiểu sản phẩm: Áo khoác không nón.\r\n2. Ưu điểm: Áo có nhiều ưu điểm nổi bật như ít nhăn, bền màu, và giữ ấm tốt nhờ lớp ngoài bằng nhung mịn. Bên trong áo là lớp lót poly mỏng, mát và thấm hút mồ hôi, giúp người mặc luôn cảm thấy thoải mái.\r\n3. Chất liệu: Áo được làm từ Corduroy với thành phần 100% Polyester.\r\n4. Kỹ thuật: Nền thêu 2D và viền thêu 3D tạo độ nổi cho họa tiết. Bo cổ, lai và tay áo sử dụng bo gân phối màu được sản xuất riêng, đồng bộ với màu áo tạo nên tổng thể hài hòa. Bộ nút kim loại cá tính và bền chắc, cùng với túi áo to có dây kéo chứa được nhiều vật dụng linh tinh.\r\n5. Phù hợp với ai: Áo khoác này phù hợp với phái mạnh yêu thích sự đa dạng phong cách và muốn phá vỡ các quy tắc thời trang thông thường. Nó mang đến vẻ ngoài năng động, cá tính và hiện đại.\r\n6. Thuộc Bộ Sưu Tập nào: Bước vào thế giới No Style - không gian thời trang không giới hạn.\r\n7. Các tên thường gọi hoặc tìm kiếm về sản phẩm này: Áo khoác kaki nhung, áo khoác bóng chày, áo khoác nam không nón.', 3213.00, 32132, 'image_product/7d10aa20-043d-3e00-19e6-001bb02f021e.jpg', 1),
(7, 'adad', 'đâsd', 2132.00, 1231, 'image_product/hoa01.jpg', 1),
(8, 'adad', 'đâsd', 2132.00, 1231, 'image_product/hoa01.jpg', 1);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `avatar` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'image_avata/avatar.png',
...
(1, 'vinh', '$2y$10$VMfDhu8EHWOGjP/c3w3Uper', 'vinh@gmail.com', '', 'user'),
(2, 'vinh1', '$2y$10$t0II5FpTLx1FOkW5aYMO7.E', 'vinh@gmail.com', '', 'user'),
(3, 'quocvinh', '$2y$10$6/9ZUFO8bB9nqcG7GN9jc.i', 'vinh1@gmail.com', '', 'user'),
(4, 'ngovinh', '$2y$10$OJ8Ekya4N3X8Mak9n5l4jeV', 'ngovinh@gmail.com', '', 'user'),
(5, 'quocvinh1', '$2y$10$G7.Hvu9U0nPLldzT1iZ/Wuh', 'quocvinh@gmail.com', '', 'user'),
(6, 'quocvinh2', '$2y$10$VApCcEs.YGS3s4wmaGPxn.K', 'quocvinh@gmail.com', '', 'user'),
(7, 'quocvinh3', '$2y$10$gEnS2tK1hVLAWq2QngAp7.2PEU6YVIjUOw05lp8Vbdupt.LPqP6Gy', 'quocvinh@gmail.com', 'image_avata/avatar.png', 'user'),
(8, 'admin', '$2y$10$nKbfv4ejUxpQbLTUgKic3ueI68YVbAow721nCbb8U.93a/mCfuRrS', 'admin@gmail.com', 'image_avata/avatar.png', 'admin');
